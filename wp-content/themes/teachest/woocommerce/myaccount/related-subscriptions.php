...
?>
<header>
	<h3><?php esc_html_e( 'Related Subscriptions', 'woocommerce-subscriptions' ); ?></h3>
</header>
	...
	<tbody>
		<?php foreach ( $subscriptions as $subscription_id => $subscription ) : ?>
			<tr class="order">
				...
				<td class="subscription-actions order-actions text-right">
					<a href="<?php echo esc_url( $subscription->get_view_order_url() ) ?>" class="btn btn-tc-default btn-sm text-uppercase"><?php esc_html_e( 'View', 'woocommerce-subscriptions' ); ?></a>
				</td>
			</tr>
		<?php endforeach; ?>
	</tbody>
