		...
		<tr>
			...
			<td>
				<?php foreach ( $actions as $key => $action ) : ?>
					<a href="<?php echo esc_url( $action['url'] ); ?>" class="btn btn-tc-default btn-sm text-uppercase <?php echo sanitize_html_class( $key ) ?>" style="margin-right:5px"><?php echo esc_html( $action['name'] ); ?></a>
				<?php endforeach; ?>
			</td>
		</tr>
	<?php endif; ?>
...
<h3><?php esc_html_e( 'Subscription Totals', 'woocommerce-subscriptions' ); ?></h3>
<div class="table-responsive">
<table class="table">
	<thead>
		<tr>
...
<header>
	<h3><?php esc_html_e( 'Customer details', 'woocommerce-subscriptions' ); ?></h3>
</header>
<div class="table-responsive">
<table class="table">
<?php
