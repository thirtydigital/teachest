...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="btn btn-tc-default btn-xl text-uppercase spacer" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
		...
		<form method="post" class="register">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-row form-row-wide">
					...
					<input type="text" class="input-text form-control input-lg" name="username" id="reg_username" value="<?php if ( ! empty( $_POST['username'] ) ) echo esc_attr( $_POST['username'] ); ?>" />
				</p>
