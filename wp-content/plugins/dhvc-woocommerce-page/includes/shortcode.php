...
class DHVC_Woo_Page_Shortcode {
	...
	public function dhvc_woo_product_page_title_shortcode($atts, $content = null) {
		...
		if(function_exists('dhvc_woo_product_page_is_jupiter_theme')){
			?>
	...
	public function dhvc_woo_product_page_custom_field_shortcode($atts, $content = null){
		...
		?>
			<div class="dhvc_woo_product_page_custom_field <?php echo esc_attr( $css_class ) ?>"><?php echo $label_html ?> <?php echo $value;?></div>
		<?php 
		endif;
		return apply_filters('dhvc_woo_product_page_custom_field',ob_get_clean (),$atts);
	}
